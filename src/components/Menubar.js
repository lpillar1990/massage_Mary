    ...
    <Navbar bg="light sticky-top" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto">
          ...
          <Nav.Link href="/prices">Menu</Nav.Link>
          {/* <Nav.Link href="/services">Services</Nav.Link> */}
          <NavDropdown title="Treatments & Prices" id="basic-nav-dropdown">
            ...
            <NavDropdown.Item href="/facialmassage">Ayurvedic Facial Massage</NavDropdown.Item>
